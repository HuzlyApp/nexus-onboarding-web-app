...
export default function ClinicalQuiz() {
  ...
  async function persist(completed: boolean) {
    ...
    if (completed) {
      localStorage.setItem("clinical_done", "true")
    }
    return true
  }
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-teal-600 p-6 text-center">
        <p className="text-white mb-4">
          ...
          <code className="bg-white/10 px-1 rounded">{CLINICAL_CATEGORY_ID}</code>. Add or fix the Clinical
