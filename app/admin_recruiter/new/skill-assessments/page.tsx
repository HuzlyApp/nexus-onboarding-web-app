...
export default function NewApplicantSkillAssessmentsDemoPage() {
  const pathname = usePathname();
  const [sidebarOpen, setSidebarOpen] = useState(false);

  const candidateName = "John Doe";
  const candidateRole = "Licensed Practical Nurse, LPN";
  const completedText = "Completed 6 of 6";

  const assessments: Assessment[] = useMemo(
    () => [
      { title: "Basic Patient Care & Hygiene", score: "10 of 10", completed: true },
      { title: "Clinical Skills & Procedures", score: "4 of 10", completed: true },
      { title: "Assessment, Monitoring & Emergency Response", score: "10 of 10", completed: true },
      { title: "Mobility Positioning & Patient Handling", score: "7 of 10", completed: true },
      { title: "Clinical Skills & Procedures", score: "5 of 10", completed: true },
      { title: "Professional Practices & Documentation", score: "9 of 10", completed: true },
    ],
    []
  );
            ...
            <div className="rounded-2xl border border-[#9CC3FF] overflow-hidden shadow-sm bg-[linear-gradient(90deg,rgba(59,130,246,0.06)_1px,transparent_1px),linear-gradient(0deg,rgba(59,130,246,0.04)_1px,transparent_1px)] bg-[size:34px_34px] bg-white/70">
              ...
              <div className="px-6 py-4 border-b border-[#9CC3FF]/20 bg-white/30">
                <div className="flex flex-wrap gap-2">
                  ...
                  {tabLink("Skill Assessments", "/admin_recruiter/new/skill-assessments", true)}
