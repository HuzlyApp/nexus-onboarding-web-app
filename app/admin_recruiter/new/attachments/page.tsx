...
type Requirement = {
  ...
  filename: string;
  size: string;
  decision: "Approved" | "Reject" | "Request More";
};

export default function NewApplicantAttachmentsFilledDemoPage() {
    ...
    () => [
      {
        ...
        filename: "nursing-license.png",
        size: "5.23 MB",
        decision: "Approved",
      },
      { id: "tb", title: "TB Test", filename: "tb-test.png", size: "5.23 MB", decision: "Approved" },
      {
        id: "cpr",
        title: "CPR Certifications",
        filename: "cpr-test.png",
        size: "5.23 MB",
        decision: "Approved",
      },
    ],
            ...
            <div className="rounded-2xl border border-[#9CC3FF] overflow-hidden shadow-sm bg-[linear-gradient(90deg,rgba(59,130,246,0.06)_1px,transparent_1px),linear-gradient(0deg,rgba(59,130,246,0.04)_1px,transparent_1px)] bg-[size:34px_34px] bg-white/70">
              ...
              <div className="px-6 py-4 border-b border-[#9CC3FF]/20 bg-white/30">
                <div className="flex flex-wrap gap-2">
                  ...
                  {tabLink("Attachments", "/admin_recruiter/new/attachments", true)}
                  {tabLink(
                    "Skill Assessments",
